...
function cargarGastos(gastosCargar){
    ...
    // Solo tienen guardados sus propiedades: descripción, valor, fecha y etiquetas
    ...
    for  ( let  g  of  gastosCargar)  { 
        ...
        // Pero sus propiedades (descripcion, valor, fecha y etiquetas) estan sin asignar 
        ...
        Object . asignar ( gastoRehidratado ,  g ) ; 
        ...
        gastos . empujar ( gastoRehidratado ) 
    }
}
